...
function read_data(a::MCParticleCollection)
    ...
    @assert typeof(mcp1)==MCParticle
    @assert typeof(mcp2)==MCParticle
    @assert typeof(mcp3)==MCParticle
    @assert typeof(mcp4)==MCParticle
    @assert typeof(mcp5)==MCParticle
    @assert typeof(mcp6)==MCParticle
    @assert typeof(mcp7)==MCParticle
    @assert typeof(mcp8)==MCParticle
